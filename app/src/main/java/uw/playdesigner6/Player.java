...
public class Player {
    ...
    public Boolean selectionStatus; //Player selection status (selected by touch event)

    public Player(float X_temp, float Y_temp , String name_temp, Boolean selection_status_temp){
        X = X_temp;
        Y = Y_temp;
        name = name_temp;
        selectionStatus = selection_status_temp;
    }

    public String toString(){
        return "ID: " + name + ", X: " + X + ", Y: " + Y + ", Selected: " + selectionStatus;
